...
7. Eliminando registros da _SCARR_ com method [_DELETE_ENTITY_]() usando as classes io_data_provider para ler os dados do postman e _me->mo_context->get_message_container( )->add_message()_ para retornar mensagem de erro.
