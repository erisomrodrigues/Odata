...
5. Inserindo dados na _SCARR_ com o [_GET_ENTITY_](Code_lab/Moovi/companhiaaereass_create_entity.abap) usando as classes _IO_DATA_PROVIDER_ para ler os dados e a classe _/IWBEP/CL_MGW_ABS_DATA_ para mensagem de erro
