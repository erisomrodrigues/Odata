...
6. Atualizando registros na _SCARR_ com method [_UPDATE_ENTITY_](Code_lab/Moovi/companhiaaereass_update_entity.abap) usando as classes io_data_provider para ler os dados do postman e me->mo_context->get_message_container( )->add_message() para retornar mensagem de erro.
